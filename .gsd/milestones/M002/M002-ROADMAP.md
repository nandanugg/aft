...
- [ ] **S01: Import Management** `risk:high` `depends:[]`
...
- [ ] **S02: Scope-aware Insertion & Compound Operations** `risk:medium` `depends:[]`
...
- [ ] **S03: Auto-format & Validation** `risk:medium` `depends:[S01]`
