...
5. When AFT tools disagree with your prior knowledge or published docs, TRUST THE TOOLS.
   They see the current source; priors can be stale. Report the disagreement explicitly.
6. AFT returns STRUCTURAL facts, not semantic guarantees. Prefer "the helper identifies N handlers"
